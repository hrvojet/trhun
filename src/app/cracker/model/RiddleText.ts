...
export const grad: string =
	'U prostoriji sličnoj prvom slovu tvog imena<br>Nezamjetna je sličica pred nosom ti skrivena<br><br>Tamo je pogled na ulicu i ženu koja krasi grad<br>Čiju državu u odgovor moraš upisati sad';
